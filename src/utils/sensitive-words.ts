...
export const sensitiveWords: SensitiveWord[] = [
  ...
  // ===== 补充更多常见违禁词 =====
  { word: '顶级', category: '极限词', severity: 'high', suggestion: '使用"高端""优质"等替代', platforms: ['all'] },
  { word: '顶尖', category: '极限词', severity: 'high', suggestion: '使用"领先""优秀"等替代', platforms: ['all'] },
  { word: '极致体验', category: '极限词', severity: 'high', suggestion: '使用"出色体验""优质体验"等替代', platforms: ['all'] },
  { word: '无与伦比', category: '极限词', severity: 'high', suggestion: '使用"出色""优秀"等替代', platforms: ['all'] },
  { word: '独一无二', category: '极限词', severity: 'high', suggestion: '使用"独特""特别"等替代', platforms: ['all'] },
  { word: '史无前例', category: '极限词', severity: 'high', suggestion: '使用"创新""突破性"等替代', platforms: ['all'] },
  { word: '前无古人', category: '极限词', severity: 'high', suggestion: '使用"创新""领先"等替代', platforms: ['all'] },
  { word: '全网热销', category: '诱导词', severity: 'medium', suggestion: '使用"人气热卖""广受欢迎"等替代', platforms: ['all'] },
  { word: '万人疯抢', category: '诱导词', severity: 'high', suggestion: '使用"人气火爆""热卖中"等替代', platforms: ['all'] },
  { word: '限时秒杀', category: '诱导词', severity: 'medium', suggestion: '使用"限时特惠""活动价"等替代', platforms: ['all'] },
  { word: '清仓大甩卖', category: '诱导词', severity: 'medium', suggestion: '使用"清仓特价""优惠出清"等替代', platforms: ['all'] },
  { word: '买到就是赚到', category: '诱导词', severity: 'high', suggestion: '使用"性价比高""值得入手"等替代', platforms: ['all'] },
  { word: '国家级专利', category: '虚假宣称', severity: 'high', suggestion: '使用"专利技术""发明专利"等（需有真实专利）', platforms: ['all'] },
  { word: '国际品质', category: '虚假宣称', severity: 'medium', suggestion: '使用"高品质""精工品质"等替代', platforms: ['all'] },
  { word: '皇室御用', category: '虚假宣称', severity: 'high', suggestion: '禁止使用此类表述', platforms: ['all'] },
  { word: '御用', category: '虚假宣称', severity: 'high', suggestion: '禁止使用此类表述', platforms: ['all'] },
  { word: '指定产品', category: '虚假宣称', severity: 'high', suggestion: '禁止使用此类表述', platforms: ['all'] },
  { word: '获奖产品', category: '虚假宣称', severity: 'medium', suggestion: '需标注具体奖项名称和年份', platforms: ['all'] },
  { word: '通过ISO认证', category: '虚假宣称', severity: 'medium', suggestion: '需有真实认证证书', platforms: ['all'] },
  { word: '通过FDA认证', category: '虚假宣称', severity: 'medium', suggestion: '需有真实认证证书', platforms: ['all'] },
  { word: '医疗级', category: '医疗违规', severity: 'high', suggestion: '非医疗器械禁止使用', platforms: ['all'] },
  { word: '临床验证', category: '医疗违规', severity: 'high', suggestion: '需有临床试验报告', platforms: ['all'] },
  { word: '临床证明', category: '医疗违规', severity: 'high', suggestion: '需有临床数据支持', platforms: ['all'] },
  { word: '医学级', category: '医疗违规', severity: 'high', suggestion: '非医疗器械禁止使用', platforms: ['all'] },
  { word: '脱敏', category: '医疗违规', severity: 'medium', suggestion: '使用"温和""舒缓"等替代', platforms: ['all'] },
  { word: '抗敏', category: '医疗违规', severity: 'medium', suggestion: '使用"舒缓""亲肤"等替代', platforms: ['all'] },
  { word: '脱发自用', category: '医疗违规', severity: 'high', suggestion: '使用"头皮养护""发根护理"等替代', platforms: ['all'] },
  { word: '排毒', category: '医疗违规', severity: 'high', suggestion: '使用"清洁""净化"等替代', platforms: ['all'] },
  { word: '清肠', category: '医疗违规', severity: 'high', suggestion: '使用"肠道健康""消化舒畅"等替代', platforms: ['all'] },
  { word: '活血化瘀', category: '医疗违规', severity: 'high', suggestion: '非药品禁止使用中医术语', platforms: ['all'] },
  { word: '补气养血', category: '医疗违规', severity: 'high', suggestion: '非药品禁止使用中医术语', platforms: ['all'] },
  { word: '延年益寿', category: '医疗违规', severity: 'high', suggestion: '禁止使用此类表述', platforms: ['all'] },
  { word: '返老还童', category: '医疗违规', severity: 'high', suggestion: '禁止使用此类表述', platforms: ['all'] },
  { word: '青春永驻', category: '虚假承诺', severity: 'high', suggestion: '使用"延缓衰老""保持年轻态"等替代', platforms: ['all'] },
  { word: '逆龄', category: '平台敏感词', severity: 'medium', suggestion: '使用"年轻态""活力肌肤"等替代', platforms: ['all'] },
  { word: '冻龄', category: '平台敏感词', severity: 'medium', suggestion: '使用"保持状态""肌肤管理"等替代', platforms: ['all'] },
  { word: '点击购买', category: '平台敏感词', severity: 'high', suggestion: '使用"查看详情""了解更多"等替代', platforms: ['douyin'] },
  { word: '购物车', category: '平台敏感词', severity: 'medium', suggestion: '使用"小黄车""橱窗"等替代', platforms: ['douyin'] },
  { word: '转账', category: '平台敏感词', severity: 'high', suggestion: '使用"付款""结算"等替代', platforms: ['douyin'] },
  { word: '红包', category: '平台敏感词', severity: 'medium', suggestion: '使用"福利""惊喜礼"等替代', platforms: ['douyin'] },
  { word: '提现', category: '平台敏感词', severity: 'high', suggestion: '使用"到账""收获"等替代', platforms: ['douyin'] },
  { word: '关注领券', category: '平台敏感词', severity: 'medium', suggestion: '使用"关注享优惠""粉丝专属福利"等', platforms: ['xiaohongshu'] },
  { word: '评论区见', category: '平台敏感词', severity: 'low', suggestion: '可使用但勿过度引导', platforms: ['xiaohongshu', 'douyin'] },
  { word: '私聊', category: '平台敏感词', severity: 'medium', suggestion: '使用"主页联系""了解更多"等替代', platforms: ['xiaohongshu', 'douyin'] },
  { word: '引流', category: '平台敏感词', severity: 'high', suggestion: '避免直接提及站外导流', platforms: ['douyin', 'xiaohongshu'] },
];
